...
class ContainerMonitor:
    ...
    def _fetch_one(self, ctr: object) -> ContainerSnapshot | None:
        ...
        return ContainerSnapshot(
            ...
            net_rx_packets=parsed["net_rx_packets"],
            net_tx_packets=parsed["net_tx_packets"],
            net_rx_errors=parsed["net_rx_errors"],
            net_tx_errors=parsed["net_tx_errors"],
            net_rx_dropped=parsed["net_rx_dropped"],
            net_tx_dropped=parsed["net_tx_dropped"],
            is_idle=is_idle,
